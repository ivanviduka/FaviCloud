...
class FileRepository
{
    ...
    {
        return File::select('file_name', 'description', 'is_public', 'file_type', 'user_id')->where('id', $file_id)->first();
    }
    ...
    public function getFileWithName($file_name)
    {
        return File::where('file_name', $file_name)->first();
    }
